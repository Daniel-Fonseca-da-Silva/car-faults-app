...
/// hero, tech specs grid, issues summary banner and shared footer.
///
/// The body between the summary banner and the footer is filled in by later
/// slices (defects, reviews, fixes, comments).
